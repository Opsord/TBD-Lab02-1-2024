 ...
 * 
 * @Repository
 * public class EmergencyAttributeRepositoryImp implements
 * EmergencyAttributeRepository {
 * 
 * private static final Logger logger =
 * Logger.getLogger(EmergencyAttributeRepositoryImp.class.getName());
 * 
 * @Autowired
 * private Sql2o sql2o;
 * 
 * @Override
 * public EmergencyAttributeEntity create(EmergencyAttributeEntity
 * emergencyAttribute) {
 * String sql =
 * "INSERT INTO emergency_attribute (emergency_id,idattribute, compatibility) "
 * +
 * "VALUES (:emergency_id, :idAttribute, :compatibility)";
 * 
 * try (Connection conn = sql2o.open()) {
 * conn.createQuery(sql)
 * .addParameter("emergency_id", emergencyAttribute.getemergency_id())
 ...
 * 
 * } catch (Exception e) {
 * logger.severe("Error al obtener todos los emergenciaAtributo: " +
 * e.getMessage());
 ...
 * String sql =
 * "SELECT * FROM emergency_attribute WHERE idattribute = :idAttribute";
 * 
 * try (Connection conn = sql2o.open()) {
 * return conn.createQuery(sql)
 ...
 * 
 * } catch (Exception e) {
 * logger.severe("Error al obtener emergenciaAtributo por id: " +
 * e.getMessage());
 * return null;
 * }
 * }
 ...
 * String sql =
 * "UPDATE emergency_attribute SET emergency_id = :emergency_id, compatibility = :compatibility "
 * +
 ...
 * String sql =
 * "DELETE FROM emergency_attribute WHERE idattribute = :idAttribute";
 * 
 * try (Connection conn = sql2o.open()) {
 * conn.createQuery(sql)
 * .addParameter("idAttribute", id)
