 ...
 * Logger.getLogger(RankingRepositoryImp.class.getName());
 * 
 * @Autowired
 ...
 * String sql =
 * "UPDATE Ranking SET volunteer = :volunteer, idtask = :idtask, value = :value "
 * +
 ...
 * 
 * @Override
 * public List<RankingEntity> getBytask_id(long idTask) {
 ...
 * 
 * } catch (Exception e) {
 * logger.severe("Error al obtener ranking por id de emergencia: " +
 * e.getMessage());
 * return Collections.emptyList();
 * }
 * }
