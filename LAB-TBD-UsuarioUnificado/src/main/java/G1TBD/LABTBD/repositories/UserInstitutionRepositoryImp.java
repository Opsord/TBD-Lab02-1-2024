...
@Repository
public class UserInstitutionRepositoryImp implements UserInstitutionRepository{

    private final Sql2o sql2o;
    private final Logger logger = Logger.getLogger(UserInstitutionRepositoryImp.class.getName());
    ...
    public UserInstitutionEntity getById(long id) {
        String sql = "SELECT * FROM User_Institution WHERE idUserInstitution = :idUserInstitution";
    ...
    public boolean update(UserInstitutionEntity userInstitution) {
        String sql = "UPDATE User_Institution SET rut = :rut, idInstitution = :idInstitution " +
    ...
    public boolean delete(long id) {
        String sql = "DELETE FROM User_Institution WHERE idUserInstitution = :idUserInstitution";
